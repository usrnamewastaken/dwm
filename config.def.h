...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_f,      spawn,          {.v = fmcmd } },
        { MODKEY|ShiftMask,             XK_e,      spawn,          {.v = ejectcmd } },
	{ 0, XF86XK_AudioLowerVolume,              spawn,          {.v = volupdowncmd } },
        { 0, XF86XK_AudioLowerVolume,              spawn,          {.v = volupdowncmd } },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_f,      spawn,          {.v = fmcmd } },
        { MODKEY|ShiftMask,             XK_e,      spawn,          {.v = ejectcmd } },
	{ MODKEY|ShiftMask,             XK_d       spawn,          {.v = volupdowncmd } },
        { MODKEY|ShiftMask,             XK_u,      spawn,          {.v = volupdowncmd } },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_f,      spawn,          {.v = fmcmd } },
        { MODKEY|ShiftMask,             XK_e,      spawn,          {.v = ejectcmd } },
	{ 0,                            XF86K_AudioLowerVolume,               spawn,          {.v = voldowncmd } },
        { 0,                            XF86K_AudioRaiseVolume,    spawn,          {.v = volupcmd } },
        { 0,                            XF86K_AudioMute,    spawn,          {.v = mutecmd } },
